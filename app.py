...
def main():
    ...
    if category == "India":
        news_data = scrape_category('https://www.ndtv.com/india/page-', 'h2', 5)
    elif category == "Latest":
        news_data = scrape_category('https://www.ndtv.com/latest/page-', 'h2', 5)
    elif category == "Cities":
        news_data = scrape_category('https://www.ndtv.com/cities/page-', 'h2', 5)
    elif category == "Education":
        news_data = scrape_category('https://www.ndtv.com/education/page-', 'h2', 5)
    elif category == "Trending":
        news_data = scrape_category('https://www.ndtv.com/trends', 'h3', 5)
    elif category == "Offbeat":
        news_data = scrape_category('https://www.ndtv.com/offbeat/page-', 'h2', 5)
    elif category == "South":
        news_data = scrape_category('https://www.ndtv.com/south/page-', 'h2', 5)
    else:
        st.error("Invalid category selected.")
